(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/forms'), require('rxjs/operators'), require('moment'), require('@angular/common'), require('@angular/core')) :
    typeof define === 'function' && define.amd ? define('angular-bootstrap-datetimepicker', ['exports', '@angular/forms', 'rxjs/operators', 'moment', '@angular/common', '@angular/core'], factory) :
    (factory((global['angular-bootstrap-datetimepicker'] = {}),global.ng.forms,global.rxjs.operators,global.moment,global.ng.common,global.ng.core));
}(this, (function (exports,forms,operators,_moment,common,core) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var DlDateAdapterString = /** @class */ (function (_super) {
        ...
        /** @nocollapse */
        DlDateAdapterString.ctorParameters = function () {
            return [
                { type: Array, decorators: [{ type: core.Inject, args: [DL_DATE_TIME_INPUT_FORMATS,] }] },
                { type: String, decorators: [{ type: core.Inject, args: [DL_DATE_TIME_MODEL_FORMAT,] }] }
            ];
        };
    ...
    var DlDateTimeInputDirective = /** @class */ (function () {
        ...
        /** @nocollapse */
        DlDateTimeInputDirective.ctorParameters = function () {
            return [
                { type: core.Renderer2 },
        ...
        DlDateTimeInputDirective.propDecorators = {
            ...
            dlDateTimeInputFilter: [{ type: core.Input }],
            _onChange: [{ type: core.HostListener, args: ['change',] }],
            _onBlur: [{ type: core.HostListener, args: ['blur',] }],
            _onInput: [{ type: core.HostListener, args: ['input', ['$event.target.value'],] }]
        };
    ...
    var DlDateTimePickerComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        DlDateTimePickerComponent.ctorParameters = function () {
            return [
                { type: core.ElementRef },
                { type: core.NgZone },
                { type: DlDateAdapter },
